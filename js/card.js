...
blackcolor.addEventListener("click",() => {
    let img = document.getElementById("product-img");
    let productpreview = document.querySelector(".product-preview");
    img.src = '../img/coffee shop.png';
    productpreview.style.background = "linear-gradient(45deg, #1C0D08, #3F241B)";
    share.style.color = "#3F241B";
    badge.style.background = "#3F241B";
    priceBtn.style.background = "#3F241B";
